...
export default function TrackOrderPage() {
  ...
  const handleTrack = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        `/api/track?orderId=${encodeURIComponent(orderId)}&phone=${encodeURIComponent(phone)}`,
      );
  ...
  const steps = [
    ...
    },
    {
      id: 2,
      title: "প্রসেসিং",
      date: currentStep >= 2 ? formatDate(orderData?.updatedAt) : "অপেক্ষমান",
      icon: Clock,
      description: "অর্ডারটি প্যাক করা হচ্ছে",
    },
    {
      id: 3,
      title: "কুরিয়ারে হস্তান্তর/শিপড",
      date: currentStep >= 3 ? formatDate(orderData?.updatedAt) : "অপেক্ষমান",
      icon: Truck,
      description: "আপনার প্যাকেজটি কুরিয়ারে দেওয়া হয়েছে",
    },
    {
      id: 4,
      title: "ডেলিভারড",
      date: currentStep >= 4 ? formatDate(orderData?.updatedAt) : "অপেক্ষমান",
      icon: PackageCheck,
      description: "অর্ডারটি সফলভাবে ডেলিভারি করা হয়েছে",
    },
  ];
              ...
              <div className="max-w-5xl">
                ...
                <div className="pb-12 text-left">
                  ...
                  <p className="text-gray-500 text-sm md:text-base">
                    আপনার অর্ডার আইডি এবং ফোন নাম্বার দিয়ে সর্বশেষ অবস্থা জানুন
                  </p>
                </div>

                {/* Search Card */}
                <div className="bg-white rounded-2xl shadow-xl shadow-black/[0.03] border border-gray-100 p-6 md:p-8 relative z-10 -mt-4">
                  <form
                ...
                {showResult && orderData && (
                  <div className="mt-8 space-y-6 animate-in slide-in-from-bottom-8 fade-in duration-500">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                      ...
                      <a
                        href="#"
                        className="bg-white text-blue-600 border border-blue-200 px-5 py-2.5 rounded-xl font-medium text-sm hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-colors"
                      >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        {isCancelled ? (
                          <div className="flex flex-col items-center justify-center py-10 text-center">
                            ...
                            <p className="text-gray-500 max-w-sm">
                              আপনার অর্ডারটি কোনো কারণে বাতিল করা হয়েছে।
                          ...
                          <>
                            ...
                            <div className="relative">
                                ...
                                {steps.map((step, idx) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      {/* Step Icon Indicator */}
                                      <div
                                        className={`relative z-10 w-12 h-12 rounded-full flex items-center justify-center shrink-0 border-[3px] transition-colors duration-500
                              ...
                              `}
                                      ...
                                      {/* Step Content */}
                                      <div
                                        className={`pt-1 pb-2 flex-1 ${!isCompleted ? "opacity-50" : ""}`}
                                      >
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-1 mb-1">
                                          <h4
                                            className={`font-bold text-[15px] ${isCompleted ? "text-gray-900" : "text-gray-500"}`}
                                          >
                                            {step.title}
                                          </h4>
                      ...
                      <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm h-fit sticky top-28">
                        <h3 className="font-bold text-gray-900 mb-6 pb-4 border-b border-gray-100">
                          অর্ডার সামারি
                        </h3>
                          ...
                          {orderData.items.map((item: any, idx: number) => (
                            <div key={idx} className="flex items-center gap-4">
                              ...
                              <div className="flex-1 min-w-0">
                                <h4 className="font-semibold text-[13px] text-gray-900 line-clamp-2">
                                  {item.title}
                                </h4>
                        ...
                        <div className="space-y-3 pt-4 border-t border-gray-100 text-sm">
                          ...
                          <div className="flex justify-between text-gray-900 font-bold text-lg pt-3 border-t border-gray-100">
                            ...
                            <span className="text-primary">
                              ৳ {toBengaliNumber(orderData.pricing?.total || 0)}
                            </span>
                          </div>
                        </div>
                      </div>
