...
export const metadata: Metadata = {
  ...
  description: "Mehzin Offers-এর প্রাইভেসি পলিসি বা গোপনীয়তা নীতিমালা।",
};
...
export default function PrivacyPolicyPage() {
  const policies = [
    ...
    "প্রয়োজনে Mehzin Offers কোনো পূর্ব ঘোষণা ছাড়াই এই নীতিমালা পরিবর্তনের সম্পূর্ণ অধিকার সংরক্ষণ করে।"
  ];
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-600 text-lg leading-relaxed max-w-2xl">
            Mehzin Offers আপনার ব্যক্তিগত তথ্যের গোপনীয়তাকে সর্বোচ্চ গুরুত্ব দেয়। 
