...
export const metadata: Metadata = {
  ...
  description: "Mehzin Offers-এর সাধারণ শর্তাবলী ও নিয়মকানুন।",
};

export default function TermsConditionsPage() {
  const policies = [
    "Mehzin Offers থেকে কেনাকাটা করার মাধ্যমে আপনি আমাদের সমস্ত শর্তাবলীতে সম্মত হচ্ছেন বলে ধরে নেওয়া হবে।",
