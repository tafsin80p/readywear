...
import { Package, Truck, CheckCircle, Clock, ChevronRight, TrendingUp, ChevronLeft } from "lucide-react";
...
export default function AccountOverview() {
  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Welcome Banner */}
      <div className="bg-gray-900 rounded-2xl md:rounded-3xl p-6 md:p-10 text-white shadow-xl relative overflow-hidden group">
