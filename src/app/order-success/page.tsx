                ...
                <div className="bg-gray-50/80 border-b border-gray-100 p-6 sm:p-8">
                  ...
                  <div className="grid grid-cols-2 gap-y-4 gap-x-2">
                    <div>
                      ...
                      <p className="text-sm font-bold text-primary">#RW-{toBengaliNumber(20489)}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 font-medium mb-1">তারিখ</p>
                      <p className="text-sm font-semibold text-gray-900">{toBengaliNumber(12)} সেপ্টে, ২০২৬</p>
                    </div>
                    <div className="col-span-2">
                      <p className="text-xs text-gray-500 font-medium mb-1">পেমেন্ট মেথড</p>
                      <p className="text-sm font-semibold text-gray-900">ক্যাশ অন ডেলিভারি (Cash on Delivery)</p>
                    </div>
                  </div>
                </div>
                        ...
                        <div className="flex-1 flex flex-col justify-center">
                          ...
                          <div className="flex items-center justify-between mt-2">
                            ...
                            <span className="font-bold text-gray-900 text-sm">
                              ৳ {toBengaliNumber(item.product.price * item.quantity)}
                            </span>
                          </div>
                        </div>
                      </div>
                ...
                <div className="p-6 sm:p-8 bg-gray-50/50 border-t border-gray-100 mt-auto">
                  <div className="space-y-3 mb-4">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium text-gray-900">৳ {toBengaliNumber(subtotal)}</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-600">ডেলিভারি চার্জ</span>
                      <span className="font-medium text-gray-900">৳ {toBengaliNumber(deliveryCharge)}</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                    <span className="font-bold text-gray-900">সর্বমোট</span>
                    <span className="text-xl font-bold text-primary">৳ {toBengaliNumber(total)}</span>
                  </div>
                </div>
